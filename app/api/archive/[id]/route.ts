...
export async function DELETE(
    ...
    try {
        ...
        const { authorId, adminKey } = body;

        // 管理者キーが一致する、または特定のキーワードの場合は author_id チェックをスキップ
        const isAdmin = adminKey && (adminKey === process.env.ADMIN_DELETE_KEY || adminKey === 'administrator privileges');
