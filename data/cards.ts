...
export const CARD_DATABASE: { [key: string]: Omit<Card, 'id'> } = {
    ...
    'c025': {
        ...
        nameJa: 'DDD智慧王ソロモン',
        descriptionJa: 'レベル４「DD」モンスター×２\n(1)：このカードのＸ素材を１つ取り除いて発動できる。デッキから「DD」カード１枚を手札に加える。\n(2)：このカードが除外された場合、自分フィールドの「DD」モンスター１体を対象として発動できる。そのモンスターは、「このカードが戦闘で相手モンスターを破壊した場合に発動する。その破壊されたモンスターの元々の攻撃力分のダメージを相手に与える」効果を得る。'
    },
    'c026': {
        cardId: 'c026',
    ...
    'c034': {
        ...
        type: 'SPELL',
        subType: 'CONTINUOUS',
        description: '(This card is always treated as a "DD" card). [1] Once per turn: You can target 1 other "DD" card you control; destroy it, and if you do, SS 1 "DD" monster from your Deck.',
        imageUrl: 'https://cdn-ak.f.st-hatena.com/images/fotolife/D/DEYE/20260203/20260203193404.png',
        descriptionJa: 'このカードはルール上「DD」カードとしても扱う。\n(1)：１ターンに１度、自分メインフェイズに、自分フィールドの他の「DD」カード１枚を対象として発動できる。そのカードを破壊し、デッキから「DD」モンスター１体を特殊召喚する。'
    },
    'c035': {
        cardId: 'c035',
    ...
    'c036': {
        ...
        imageUrl: 'https://cdn-ak.f.st-hatena.com/images/fotolife/D/DEYE/20260225/20260225175522.png',
        nameJa: 'ワン・フォー・ワン',
    ...
    'c_token_nibiru': {
        ...
        type: 'MONSTER',
        description: 'This Token can be Special Summoned with the effect of "Nibiru, the Primal Being".',
        attack: 0,
        defense: 0,
        level: 11,
